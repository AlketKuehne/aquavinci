...
export default function ReviewAndConfirmPage() {
  ...
  // Example data (replace with actual data passed to the page)
      ...
      <div className="pt-16 px-8">
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          <div className="bg-white p-4 shadow-md rounded-lg flex justify-between items-center">
            <div>
              <h2 className="text-lg font-semibold">Shipment Type</h2>
          ...
          {fields.shipmentType === "FCL" && (
            <div className="bg-white p-4 shadow-md rounded-lg flex justify-between items-center">
              <div>
                <h2 className="text-lg font-semibold">Number of Containers</h2>
          ...
          {fields.shipmentType === "LCL" && (
            <div className="bg-white p-4 shadow-md rounded-lg flex justify-between items-center">
              <div>
                <h2 className="text-lg font-semibold">Number of Packages</h2>
          ...
          <div className="bg-white p-4 shadow-md rounded-lg">
            <h2 className="text-lg font-semibold mb-4">Size & Weight Details</h2>
          ...
          {fields.isFragile && (
            <div className="bg-white p-4 shadow-md rounded-lg">
              <h2 className="text-lg font-semibold mb-4">Fragile Item</h2>
              <div className="grid grid-cols-2 gap-4">
