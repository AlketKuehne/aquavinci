...
export default function ShipmentPage() {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen">
      ...
      {/* Page Content */}
      <div className="flex flex-col items-start w-full max-w-6xl mt-12 px-8"> {/* Increased `mt-8` to `mt-12` */}
        <h1 className="text-4xl font-extrabold mb-12 self-start">Create Shipment</h1> {/* Increased `mb-8` to `mb-12` */}

        {/* First Form Section */}
        <div className="flex justify-between w-full gap-x-4 mt-4"> {/* Added `mt-4` */}
          {/* Shippers Box */}
        ...
        <div className="flex justify-between w-full mt-8 gap-x-4"> {/* Increased `mt-6` to `mt-8` */}
          {/* From Box */}
          <div className="bg-white p-6 shadow-lg rounded-lg w-1/2">
